        ...
        return (
            <div className="card">
                <form className="admin-form ajouter-recette" onSubmit={this.handleSubmit}>
                    ...
                    <textarea value={this.state.ingredients} onChange={this.handleChange}  name="ingredients" row="3" placeholder='Liste des ingrédients' />
                    <textarea value={this.state.instructions} onChange={this.handleChange}  name="instructions" row="15" placeholder='Liste des instructions' />
